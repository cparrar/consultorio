...
use ConsultorioBundle\Entity\Historial;
...
class HistorialController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $historials = $em->getRepository('ConsultorioBundle:Historial')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ConsultorioBundle\Form\HistorialType', $historial);
    ...
    {
        $deleteForm = $this->createDeleteForm($historial);
        $editForm = $this->createForm('ConsultorioBundle\Form\HistorialType', $historial);
